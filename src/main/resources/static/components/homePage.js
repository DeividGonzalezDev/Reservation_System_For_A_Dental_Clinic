export function homePage() {
  return (
    `<section id="principal-banner" class="bg-white dark:bg-gray-900">
          <div
          ...
          >
            ...
            >
              ...
              <span class="text-sm font-medium"
                >Sonrisa con IA! Nuestra nueva tecnología</span
              >
              <svg
                class="ml-2 w-5 h-5"
                fill="currentColor"
            ...
            >
              Nuestra clínica te ofrece servicios de odontología de primera
              calidad, respaldados por años de experiencia y tecnología de
              vanguardia. Desde limpiezas y blanqueamiento dental hasta implantes
              y ortodoncia, estamos comprometidos a brindarte resultados
              impecables.
            </p>
            <div
            ...
            >
              <a
                class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 cursor-pointer booking-button"
              >
                Reservar Ahora!!
                <svg
        ...
        <section id="our-dentists" class="bg-white dark:bg-gray-900">
          <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
              ...
              >
                Conoce a los mas destacados y reconocidos Odontólogos del Pais,
                ellos harán que tu sonrisa sea perfecta!
              </p>
            </div>
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
              ...
              >
                ...
                <div class="p-5">
                  ...
                  <span class="text-gray-500 dark:text-gray-400">Odontóloga</span>
                  <p
                    class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                  >
                    Reconocida en el NewYorkTimes como una de las mejores
                    odontologas del Pais
                  </p>
              ...
              >
                ...
                <div class="p-5">
                  ...
                  <span class="text-gray-500 dark:text-gray-400"
                    >Doctor en Odontología (DDS)</span
                  >
                  <p
                    class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                  >
                    Odontólogo reconocido porque... estudió en Harvard
                  </p>
                  <ul class="flex space-x-4 sm:mt-0">
                    <li>
                      <a
              ...
              >
                ...
                <div class="p-5">
                  ...
                  <p
                    class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                  >
                    Reconocido en la revista Times, como el Odontólgo mas
                    influyente del año
                  </p>
                  <ul class="flex space-x-4 sm:mt-0">
                    <li>
              ...
              >
                ...
                <div class="p-5">
                  ...
                  <span class="text-gray-500 dark:text-gray-400"
                    >Doctor en Medicina Dental (DMD)</span
                  >
                  <p
                    class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                  >
                    Reconocida por ser la Odontóloga del Siglo, con muchas
                    condecoraciones incluidos un Oscar y un Grammy
                  </p>
                  <ul class="flex space-x-4 sm:mt-0">
                    <li>
                      <a
