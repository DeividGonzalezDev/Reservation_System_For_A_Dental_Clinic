export function showAllDentits() {
  return (
    `<!-- Start block -->
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table id="booking-table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    id="surname"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Escribe el apellido del Odontólogo"
                  />
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    id="licenseNumber"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Escribe la Matrícula del Odontólogo"
                    required=""
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    id="homeAddress"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Escribe la dirección del Odontólogo"
                    required=""
                  />
                </div>
                <div class="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Proporciona mas detalles sobre el Odontólogo"
                  ></textarea>
                </div>
              </div>
              <button
