export function showAllUserBookings() {
  return `<!-- Start block -->
            ...
            <div class="overflow-x-auto">
                <table id="booking-table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">Fecha de Creacion de la Reserva</th>
                            <th scope="col" class="px-4 py-3">Odontólogo/a</th>
                            <th scope="col" class="px-4 py-3">Paciente</th>
                            <th scope="col" class="px-4 py-3">Fecha de Reserva</th>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Nueva Reserva</h3>
